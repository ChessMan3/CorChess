...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // King
   { S(248,  0), S(305, 42), S(260, 75), S(189, 76) },
   { S(278, 43), S(287, 97), S(237,140), S(166,138) },
   { S(194, 86), S(245,129), S(160,165), S(105,160) },
   { S(172,105), S(189,177), S(151,155), S(107,161) },
   { S(169,112), S(175,167), S(112,203), S( 61,195) },
   { S(121, 87), S(148,161), S( 83,180), S( 36,172) },
   { S( 82, 42), S(124, 98), S( 65,107), S( 16,119) },
   { S( 59,  2), S( 81, 50), S( 45, 69), S(  1, 84) }
  }
};
